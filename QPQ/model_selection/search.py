...
class BaseSearchCV(with_metaclass(ABCMeta)):
    ...
    def fit(self, data):
        ...
        Args:
            data (:obj:`Dataset <QPQ.dataset.Dataset>`): The dataset on
    ...
    def test(self, testset, verbose=False):
        ...
        <QPQ.prediction_algorithms.algo_base.AlgoBase.test>`.
    ...
    def predict(self, *args):
        ...
        <QPQ.prediction_algorithms.algo_base.AlgoBase.predict>`.
