'''
The :mod:`model_selection.split<QPQ.model_selection.split>` module
contains various cross-validation iterators. 
...
class KFold():
    ...
    def split(self, data):
        ...
        Args:
            data(:obj:`Dataset<QPQ.dataset.Dataset>`): The data containing
...
class PredefinedKFold():
    ...
    :meth:`load_from_folds <QPQ.dataset.Dataset.load_from_folds>`
    method.
