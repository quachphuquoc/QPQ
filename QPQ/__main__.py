...
from QPQ.prediction_algorithms import NormalPredictor
from QPQ.prediction_algorithms import BaselineOnly
from QPQ.prediction_algorithms import KNNBasic
from QPQ.prediction_algorithms import KNNBaseline
from QPQ.prediction_algorithms import KNNWithMeans
from QPQ.prediction_algorithms import SVD
from QPQ.prediction_algorithms import SVDpp
from QPQ.prediction_algorithms import NMF
from QPQ.prediction_algorithms import SlopeOne
from QPQ.prediction_algorithms import CoClustering
import QPQ.dataset as dataset
from QPQ.dataset import Dataset
from QPQ.reader import Reader  # noqa
from QPQ.builtin_datasets import get_dataset_dir
from QPQ.model_selection import cross_validate
from QPQ.model_selection import KFold
from QPQ.model_selection import PredefinedKFold
from QPQ import __version__
...
def main():
    ...
    parser = MyParser(
        ...
        '(https://github.com/quachphuquoc) for more details.',
        epilog="""Example:\n
        QPQ -algo SVD -params "{'n_epochs': 5, 'verbose': True}"
        -load-builtin ml-25M-n-folds 3""")
