"""
The :mod:`QPQ.prediction_algorithms.algo_base` module defines the base
...
class AlgoBase(object):
    ...
    def fit(self, trainset):
        ...
        Args:
            trainset(:obj:`Trainset <QPQ.Trainset>`) : A training
                set, as returned by the :meth:`folds
                <QPQ.dataset.Dataset.folds>` method.
    ...
    def predict(self, uid, iid, r_ui=None, clip=True, verbose=False):
        ...
        <QPQ.prediction_algorithms.algo_base.AlgoBase.default_prediction>`.
        ...
        Returns:
            A :obj:`Prediction\
            <QPQ.prediction_algorithms.predictions.Prediction>` object
            containing:
    ...
    def default_prediction(self):
        ...
        <QPQ.prediction_algorithms.algo_base.AlgoBase.predict>`. By
    ...
    def test(self, testset, verbose=False):
        ...
        Args:
            testset: A test set, as returned by a :ref:`cross-validation
                ...
                :meth:`build_testset() <QPQ.Trainset.build_testset>`
                method.
        ...
        Returns:
            ...
            <QPQ.prediction_algorithms.predictions.Prediction>` objects
    ...
    def compute_baselines(self):
        ...
        baseline similarty<QPQ.similarities.pearson_baseline>` or the
        :class:`BaselineOnly
        <QPQ.prediction_algorithms.baseline_only.BaselineOnly>` algorithm.
